...
#define ENABLE_BITMASK_OPERATORS(e)\
	...
	inline bool IsBitsSet(e val, e flag)	{ return ENUM_CAST(e, val & flag) > ENUM_CAST(e, 0); } \
...
//template<typename Enum>
//typename std::enable_if<EnableBitMaskOperators<Enum>::enable, Enum>::type
//bool IsBitsSet(Enum& lhs, Enum rhs)
//{
//    return static_cast<std::underlying_type_t<Enum>>(lhs & rhs) > std::underlying_type_t<Enum>(0);
//}
