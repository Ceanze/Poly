...
namespace Poly
{
	...
	enum class FResourceBindPoint
	{
		...
		INTERNAL_USE		= FLAG(10),
		SCENE_INSTANCE		= FLAG(11),
		SCENE_VERTEX		= FLAG(12),
		SCENE_TEXTURES		= FLAG(13),
		SCENE_MATERIAL		= FLAG(14),
		ALL_SCENES			= SCENE_INSTANCE | SCENE_VERTEX | SCENE_TEXTURES | SCENE_MATERIAL,
	};
