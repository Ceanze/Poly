...
namespace
{
	Poly::FResourceBindPoint SpvDescriptorTypeToPoly(SpvReflectDescriptorType type)
	{
		...
		case SPV_REFLECT_DESCRIPTOR_TYPE_SAMPLER:
			return Poly::FResourceBindPoint::SAMPLER;
		case SPV_REFLECT_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER:
			return Poly::FResourceBindPoint::SAMPLER;
		case SPV_REFLECT_DESCRIPTOR_TYPE_SAMPLED_IMAGE:
			return Poly::FResourceBindPoint::SAMPLED_IMAGE;
		case SPV_REFLECT_DESCRIPTOR_TYPE_STORAGE_IMAGE:
			return Poly::FResourceBindPoint::STORAGE_IMAGE;
		case SPV_REFLECT_DESCRIPTOR_TYPE_UNIFORM_TEXEL_BUFFER:
			return Poly::FResourceBindPoint::UNIFORM_TEXEL;
		case SPV_REFLECT_DESCRIPTOR_TYPE_STORAGE_TEXEL_BUFFER:
			return Poly::FResourceBindPoint::STORAGE_TEXEL;
		case SPV_REFLECT_DESCRIPTOR_TYPE_UNIFORM_BUFFER:
			return Poly::FResourceBindPoint::UNIFORM;
		case SPV_REFLECT_DESCRIPTOR_TYPE_STORAGE_BUFFER:
			return Poly::FResourceBindPoint::STORAGE;
		case SPV_REFLECT_DESCRIPTOR_TYPE_UNIFORM_BUFFER_DYNAMIC:
			return Poly::FResourceBindPoint::UNIFORM_DYNAMIC;
		case SPV_REFLECT_DESCRIPTOR_TYPE_STORAGE_BUFFER_DYNAMIC:
			return Poly::FResourceBindPoint::STORAGE_DYNAMIC;
		case SPV_REFLECT_DESCRIPTOR_TYPE_INPUT_ATTACHMENT:
			return Poly::FResourceBindPoint::INPUT_ATTACHMENT;
		default:
			return Poly::FResourceBindPoint::NONE;
		}
	}
} // namespace
	...
	ShaderReflection ShaderReflector::Reflect()
	{
		...
		// Inputs (stage inputs e.g. vertex attributes)
		{
			...
			for (auto* input : inputs)
			{
				...
				result.Inputs.push_back({input->name ? input->name : "",
				                         input->location});
			}
		}
		...
		// Outputs (stage outputs e.g. textures)
		{
			...
			for (auto* output : outputs)
			{
				...
				result.Outputs.push_back({output->name ? output->name : "",
				                          output->location});
			}
		}
		...
		// Descriptor bindings
		{
			...
			{
				result.Bindings.push_back({binding->name ? binding->name : "",
				                           binding->set,
				                           binding->binding,
