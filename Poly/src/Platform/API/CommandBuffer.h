...
namespace Poly
{
	...
	public:
		...
		*/
		 ...
		 */
		virtual void BindDescriptor(const Pipeline* pPipeline, const DescriptorSet* pDescriptor, uint32 dynamicOffsetCount = 0, const uint32* pDynamicOffsets = nullptr) = 0;
