...
namespace Poly
{
	inline EKey ConvertToPolyKey(int GLFWKey)
	{
		...
		// Keypad
		case GLFW_KEY_KP_0:
			return EKey::KEYPAD_0;
		case GLFW_KEY_KP_1:
			return EKey::KEYPAD_1;
		case GLFW_KEY_KP_2:
			return EKey::KEYPAD_2;
		case GLFW_KEY_KP_3:
			return EKey::KEYPAD_3;
		case GLFW_KEY_KP_4:
			return EKey::KEYPAD_4;
		case GLFW_KEY_KP_5:
			return EKey::KEYPAD_5;
		case GLFW_KEY_KP_6:
			return EKey::KEYPAD_6;
		case GLFW_KEY_KP_7:
			return EKey::KEYPAD_7;
		case GLFW_KEY_KP_8:
			return EKey::KEYPAD_8;
		case GLFW_KEY_KP_9:
			return EKey::KEYPAD_9;
		case GLFW_KEY_KP_DECIMAL:
			return EKey::KEYPAD_DECIMAL;
		case GLFW_KEY_KP_DIVIDE:
			return EKey::KEYPAD_DIVIDE;
		case GLFW_KEY_KP_MULTIPLY:
			return EKey::KEYPAD_MULTIPLY;
		case GLFW_KEY_KP_SUBTRACT:
			return EKey::KEYPAD_SUBTRACT;
		case GLFW_KEY_KP_ADD:
			return EKey::KEYPAD_ADD;
		case GLFW_KEY_KP_ENTER:
			return EKey::KEYPAD_ENTER;
		case GLFW_KEY_KP_EQUAL:
			return EKey::KEYPAD_EQUAL;
		...
		case GLFW_MOUSE_BUTTON_1:
			return EKey::MOUSE_1; // EKey::LEFT
		case GLFW_MOUSE_BUTTON_2:
			return EKey::MOUSE_2; // EKey::RIGHT
		case GLFW_MOUSE_BUTTON_3:
			return EKey::MOUSE_3; // EKey::MIDDLE
	...
	inline FKeyModifier ConvertToPolyModifier(int GLFWModifer)
	{
		...
		if ((GLFWModifer & GLFW_MOD_SHIFT) > 0)
			mask |= FKeyModifier::SHIFT;
		if ((GLFWModifer & GLFW_MOD_CONTROL) > 0)
			mask |= FKeyModifier::CTRL;
		if ((GLFWModifer & GLFW_MOD_ALT) > 0)
			mask |= FKeyModifier::ALT;
		if ((GLFWModifer & GLFW_MOD_CAPS_LOCK) > 0)
			mask |= FKeyModifier::CAPS_LOCK;
		if ((GLFWModifer & GLFW_MOD_NUM_LOCK) > 0)
			mask |= FKeyModifier::NUM_LOCK;
		return mask;
	}
} // namespace Poly