...
namespace Poly
{
	...
	std::string PVKCommandQueue::GetQueueName()
	{
		switch (m_QueueType)
		{
			...
			case FQueueType::SPARSE_BINDING:	return "SPARSE_BINDING";
			case FQueueType::VIDEO_DECODE:		return "VIDEO_DECODE";
			case FQueueType::VIDEO_ENCODE:		return "VIDEO_ENCODE";
			case FQueueType::OPTICAL_FLOW:		return "OPTICAL_FLOW";
			case FQueueType::DATA_GRAPH:		return "DATA_GRAPH";
